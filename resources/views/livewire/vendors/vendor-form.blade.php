        ...
        <form wire:submit="save" class="space-y-6">
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <x-form-input name="vendor_name" label="Supplier / Vendor Name" wire:model="vendor_name" required />
                    ...
                    <x-form-input name="vendor_type" label="Supplier Type" wire:model="vendor_type" />
                    <div class="space-y-2">
                        <x-input-label for="vendor_category_id" :value="__('Vendor Category')" />
                    ...
                    <x-form-input name="registration_number" label="GST / Tax / Registration No" wire:model="registration_number" />
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <x-form-input name="primary_contact_person" label="Contact Person" wire:model="primary_contact_person" />
                    <x-form-input name="primary_email" label="Primary Email" type="email" wire:model="primary_email" />
                    <x-form-input name="accounts_email" label="Accounts Email" type="email" wire:model="accounts_email" />
                    <x-form-input name="po_email" label="Purchase Email" type="email" wire:model="po_email" />
                    <x-form-input name="primary_phone" label="Primary Phone" wire:model="primary_phone" />
                    <x-form-input name="alternate_phone" label="Alternate Phone" wire:model="alternate_phone" />
                </div>
            </div>
            ...
            <div>
                ...
                @if ($blocked)
                    <div class="mt-3">
                        <x-form-input name="blocked_reason" label="Blocked Reason" wire:model="blocked_reason" required />
                    </div>
                @endif
                @if ($blacklisted)
                    <div class="mt-3">
                        <x-form-input name="blacklist_reason" label="Blacklist Reason" wire:model="blacklist_reason" required />
                    </div>
                @endif
            </div>
